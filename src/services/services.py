...
longer need a worker thread either: TrackerEngine.refresh_tracker_data() runs its
...
class TrackerSyncService(BaseService):
    ...
    async def refresh_incremental(self):
        ...
        if not self.core.tracker_engine:
        ...
        try:
            ...
            await self.core.tracker_engine.refresh_tracker_data(incremental=True)
    ...
    async def refresh_full(self):
        ...
        try:
            ...
            await self.core.tracker_engine.refresh_tracker_data(incremental=False)
